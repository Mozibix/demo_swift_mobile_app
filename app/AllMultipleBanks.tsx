...
const AllMultipleBanks: React.FC = () => {
  ...
  function handleSendRedirect() {
    ...
    router.push("/MultipleTransferSummary");
  }
      ...
      <View style={styles.header}>
        ...
        <View style={styles.addButtonContainer}>
          <TouchableOpacity
            ...
            onPress={() => router.push("/MultipleBankTransfer")}
          >
      ...
      >
        {bankRecipients.map((recipient) => (
          <View style={styles.users} key={recipient.account_number}>
            ...
            <View>
              <Text style={styles.name}>{recipient.account_name}</Text>
              <Text style={styles.account}>{recipient.account_number}</Text>
              <Text style={styles.account}>{recipient.bank_name}</Text>
            </View>
        ...
        <Text style={styles.total}>
          Total Amount: N{formatBalance(getTotalBankAmount())}
        </Text>
        {/* <Text style={styles.subtotal}>Multiple Transfer Fees: N20.23</Text> */}

        <Button text="Send" onPress={handleSendRedirect} />
      </ScrollView>
