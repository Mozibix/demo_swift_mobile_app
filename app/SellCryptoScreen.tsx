  ...
  const options = [
    {
      ...
      description:
        "Sell and exchange at amazing rates, and get your hard currency in cash or via Bank transfer.",
      image: require("../assets/icons/dollar.png"),
      route: "/BureauDeChangeSell" as Href,
    },
    ...(isCryptoEnabled
      ? [
          {
    ...
    //   description:
    //     "Sell Gift Cards swiftly at affordable rates. Fast, easy & reliable.",
    //   image: require("../assets/icons/gift.png"),
    //   route: "/ComingSoon" as Href,
    // },
  ];
