  ...
  async function registerForPushNotificationsAsync() {
    ...
    if (Device.isDevice) {
      ...
      if (finalStatus !== "granted") {
        alert(
          "Push notifications are currently disabled. Please enable them in your device settings to stay updated"
        );
        return;
      }
      ...
      renderToast={(toastOptions) => (
        <View
          style={{
            ...
            paddingVertical: 10,
            backgroundColor:
              toastOptions.type === "success" ? "#28a745" : "#dc3545",
            borderRadius: 8,
            flexDirection: "row",
            alignItems: "center",
            gap: 10,
            ...
            {isConnected && (
              ...
              >
                ...
                >
                  ...
                  />
                  <Stack.Screen
                    name="MultipleBankTransfer"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="AllMultipleBanks"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="MultipleTransferSummary"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="MultipleSwiftpayTransfer"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="AllMultipleSwiftpay"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="MultipleSwiftpaySummary"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="SaveNow"
                  ...
                  />
                  <Stack.Screen
                    name="ChangeSwiftpayTag"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="CreateSwiftpayTag"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="CustomerCare"
                  ...
                  />
                  <Stack.Screen
                    name="HoldingsSaveInHardCurrency"
                    options={{ headerShown: false }}
                  />
                  ...
                  />
                  <Stack.Screen
                    name="AjoContributionDashboard"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="AjoContributionHistory"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="CreateAjo"
                  ...
                  />
                  <Stack.Screen
                    name="StartAjoSavings"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="CreateAjoSavings"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="AjoSavingsDetails"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="AllAjoHistory"
                  ...
                  />
                  <Stack.Screen
                    name="CreateInvestHoldings"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="EditAjoContribution"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="JoinGroup"
                  ...
                  />
                  <Stack.Screen
                    name="GroupSavingsCreated"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="EditGroupSavings"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="Members"
                  ...
                  />
                  <Stack.Screen
                    name="BureauDeChangeSell"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
                    name="HardCurrencyDetails"
                    options={{ headerShown: false }}
                  />
                  <Stack.Screen
