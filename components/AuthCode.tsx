...
const AuthCode = () => {
    ...
    try {
      ...
      showSuccessToast({
        ...
        desc:
          ...
          "Check yur email for the new verification code",
      });
    } catch (error: any) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View
        style={[styles.container, { paddingTop: IS_ANDROID_DEVICE ? 10 : 0 }]}
      >
        ...
        {counter > 0 ? (
          <Text className="mt-2 mb-4">
            Resend code in{" "}
            <Text className="text-swiftPayBlue font-semibold">{counter}s</Text>
          </Text>
        ) : (
